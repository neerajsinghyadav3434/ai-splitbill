...
export const spendingInsights = inngest.createFunction(
  ...
  {
    // 1st of every month at 08:00 AM UTC (1:30 PM IST)
    // For 8 AM IST on 1st, use: "30 2 1 * *"
    cron: "0 8 1 * *"
  },
  async ({ step }) => {
...
Use a friendly, encouraging tone. Format your response in HTML for an email. Use ₹ (Indian Rupee) for all currency values.
