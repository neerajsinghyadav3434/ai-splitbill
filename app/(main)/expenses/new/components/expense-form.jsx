    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 pt-2">
      <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                step="0.01"
                min="0.01"
                className="h-11 pl-8 border-gray-300 focus:border-violet-500 focus:ring-violet-500"
                {...register("amount")}
              />
            </div>
            {errors.amount && (
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  variant="outline"
                  className={cn(
                    "w-full h-11 justify-start text-left font-normal border-gray-300 hover:bg-gray-50",
        ...
        {type === "individual" && (
          <div className="space-y-2">
            ...
            {participants.length <= 1 && (
              <div className="flex items-start gap-2 text-sm text-amber-700 bg-amber-50 border border-amber-200 rounded-lg p-3">
                <span className="text-base">💡</span>
                <span>Please add at least one other participant</span>
              </div>
            )}
          </div>
        )}
        ...
        <div className="space-y-2">
          ...
          <select
            className="w-full h-11 rounded-md border border-gray-300 bg-white px-3 text-sm focus:border-violet-500 focus:ring-violet-500 focus:outline-none"
          ...
          {errors.paidByUserId && (
            <p className="text-sm text-red-600 flex items-center gap-1">
              <span className="text-xs">⚠</span> {errors.paidByUserId.message}
            </p>
          )}
        </div>
        ...
        <div className="space-y-3">
          <Label className="text-sm font-medium text-gray-900">Split type</Label>
          <Tabs
            defaultValue="equal"
      ...
      <div className="flex justify-end gap-3 pt-6 border-t">
        <Button
          ...
          className="min-w-[160px] shadow-lg shadow-violet-500/30"
        >
