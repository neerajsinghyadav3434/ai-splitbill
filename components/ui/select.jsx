...
function SelectItem({
  ...
  return (
    (<SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-violet-50 focus:text-violet-900 hover:bg-gray-50 relative flex w-full cursor-pointer items-center gap-2 rounded-md py-2 pr-8 pl-3 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 transition-colors",
        className
      )}
      {...props}>
